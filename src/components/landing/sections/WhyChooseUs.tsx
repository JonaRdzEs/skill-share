      ...
      <div className="md:flex md:items-center md:gap-8">
        ...
        <div>
          <ReasonInfo
            ...
            description="All our instructors are vetted professionals with proven expertise in their fields."
            icon={
              <Shield
                width={30}
                height={30}
          ...
          <ReasonInfo
            ...
            description="Join a vibrant community of learners and experts who support each other."
            icon={
              <UsersGroup
                width={30}
                height={30}
